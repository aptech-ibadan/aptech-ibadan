    ...
    <div className="mb-4">
        ...
        <div className="grid grid-cols-1 items-center justify-between gap-10 md:grid-cols-2">
          <div className="p-6">
            <div className="font-nav px-4 py-6 md:max-w-8xl">
              <h3 className="mt-8 text-2xl  font-bold md:text-6xl">
                CONTACT US
              </h3>
              <p className="mt-2 md:m-2 text-md md:text-lg ">
                We want to hear from you! Visit our office or Reach out and
                share comments, suggestions, or concerns on all social media
                platforms.
              </p>
            </div>
          </div>
      ...
      <div className="container-xl lg:container m-auto">
        <div className="grid grid-cols-1 items-center justify-between px-4 py-2 space-y-6 md:space-x-8 lg:grid-cols-2">
          <div className="mt-8">
            <h1 className="text-2xl py-2 text-center font-bold font-sans tracking-wide md:text-4xl md:text-left">
              Contact Us at
            </h1>
            <div>
              <div className="flex items-center gap-8 mt-4">
                <FaMapMarker className="h-6 w-6 text-red-500" />
                <p className=" text-blue-950 font-nav text-sm">
                  WestOne building, Opposite Environmental Task force, Agodi
                  GRA, Ibadan
                </p>
              </div>
              <div className="flex items-center gap-8 mt-4">
                ...
                <p className=" text-blue-950 font-nav text-sm">
                  <a href="mailto:info@itssng.com">info@itssng.com</a>
                </p>
              </div>
              <div className="flex items-center gap-8 mt-4">
                <FaPhone className="h-6 w-6 text-black" />
                <p className=" text-blue-950 font-nav text-sm">
                  <a href="tel:+2341112223333">[+234 111 222 3333]</a>
                  +234 111 222 3333
                </p>
              </div>
              <div className="flex items-center gap-8 mt-4">
                <FaFacebook className="h-6 w-6 text-blue-700" />
                <p className=" text-blue-950 font-nav text-sm">Aptech Ibadan</p>
              </div>
              <div className="flex items-center gap-8 mt-4">
