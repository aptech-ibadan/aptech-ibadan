...
const courseData = {
  ...
  arenaCourse: {
    ...
    certification:
      "Certificate of Accomplishment / Certificate of Participation",
    image:
      "https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=464&auto=format&fit=crop",
        ...
        courses: [
          {
            ...
            modules: [
              {
                name: "Concepts of Graphics and Illustrations",
                software: "Concept",
                theory: 16,
                lab: 8,
                total: 24,
              ...
              {
                name: "Publishing for the Media",
                software: "Adobe Indesign & Incopy",
                theory: 20,
                lab: 16,
                total: 36,
              },
          ...
          },
          {
            ...
            hours: 114,
            certificate:
              "Certificate of Accomplishment in Print and Publishing",
            modules: [
              {
                name: "Concepts of Graphics and Illustrations",
                software: "Concept",
              ...
              {
                name: "Design for Print and Advertising",
                software: "Concept",
                theory: 6,
                lab: 8,
                total: 14,
          ...
          },
          {
            ...
            modules: [
              ...
              },
              {
                ...
                software: "HTML5, CSS3 and Javascript",
                theory: 20,
                lab: 20,
                total: 40,
              },
          ...
          },
          {
            ...
            hours: 250,
            certificate:
              "Certificate of Accomplishment in Digital Graphics and Animation",
            modules: [
              {
                name: "Concepts of Graphics and Illustrations",
                software: "-",
              ...
              {
                name: "3D Basics - Modeling to Animation",
                software: "-",
                theory: 8,
                lab: 0,
                total: 8,
              ...
              {
                name: "3DS Max with V-Ray",
                software: "3ds Max latest version",
                theory: 40,
                lab: 40,
                total: 80,
              },
          ...
          },
          {
            ...
            modules: [
              {
                name: "Modeling 3D Objects with Maya",
                software: "MAYA",
                theory: 14,
                lab: 14,
                total: 28,
              ...
              {
                name: "Texturing 3D Objects with Maya",
                software: "MAYA",
                theory: 14,
                lab: 14,
                total: 28,
              ...
              {
                name: "Lighting and Rendering 3D Objects with Maya",
                software: "MAYA",
                theory: 12,
                lab: 12,
                total: 24,
              ...
              {
                name: "Rigging 3D Objects with MAYA",
                software: "MAYA",
                theory: 12,
                lab: 12,
                total: 24,
              ...
              {
                name: "Character Animation with Maya",
                software: "MAYA",
                theory: 14,
                lab: 14,
                total: 28,
          ...
          },
          {
            ...
            hours: 88,
            certificate:
              "Certificate of Accomplishment in Basics of 3D Animation",
            modules: [
              {
                name: "3D Basics - Modeling to Animation",
                software: "Concept",
          ...
          },
          {
            ...
            hours: 222,
            certificate:
              "Certificate of Accomplishment in Advanced 3D Animation with Maya",
            modules: [
              {
                name: "3D Basics - Modeling to Animation",
                software: "-",
              ...
              {
                name: "Portfolio development with Demo Reel",
                software: "-",
                theory: 2,
                lab: 0,
                total: 2,
          ...
          },
          {
            ...
            hours: 124,
            certificate:
              "Certificate of Accomplishment in 3D Interior Designing",
            modules: [
              {
                name: "Model Designing with Autocad",
                software: "Autocad",
                theory: 20,
                lab: 24,
                total: 44,
          ...
          },
          {
            ...
            hours: 44,
            certificate:
              "Certificate of Accomplishment in Industrial Art (AutoCAD)",
            modules: [
              {
                name: "Model Designing with Autocad",
                software: "Autocad",
            ...
            learningOutcomes: ["Create 3D Drawings using AutoCAD"],
          },
        ],
      },
      {
        ...
        courses: [
          ...
          },
          {
            ...
            hours: 20,
            certificate:
              "Certificate of Participation in Digital Illustrations",
            modules: [
              {
                name: "Digital Illustrations",
                software: "Adobe Illustrator",
            ...
            learningOutcomes: [
              "Create digital artworks/Illustrations using Illustrator",
            ],
          },
          {
            name: "CorelDraw",
            ...
            modules: [
              {
                name: "Creating Artworks with CorelDraw",
                software: "CorelDRAW",
                theory: 10,
                lab: 14,
                total: 24,
            ...
            jobProfiles: ["Illustrator", "Graphic Designer"],
            learningOutcomes: [
              "Create digital artworks/Illustrations using Corel Draw",
            ],
          },
          {
            ...
            modules: [
              {
                name: "Page Design",
                software: "Adobe Indesign and InCopy",
                theory: 20,
                lab: 16,
                total: 36,
              },
          ...
          },
          {
            ...
            modules: [
              {
                name: "Video Editing",
                software: "Adobe Premiere and Prelude",
                theory: 18,
                lab: 14,
                total: 32,
              },
            ...
            learningOutcomes: [
              "Edit and composite videos using Adobe Premiere and Prelude",
            ],
          },
          {
            ...
            learningOutcomes: [
              "Create, record, and edit audio using Adobe Audition",
            ],
          },
          {
            ...
            learningOutcomes: [
              "Create digital motion graphics and composite images using After Effects",
            ],
          },
          {
            ...
            modules: [
              {
                name: "2D Animation Concepts & 2D Animation using Animate CC",
                software: "Adobe Animate",
                theory: 22,
                lab: 28,
                total: 50,
            ...
            learningOutcomes: [
              "Create 2D digital animation using Adobe Animate",
            ],
          },
          {
            name: "Web Animation using Animate CC",
            hours: 32,
            certificate:
              "Certificate of Participation in Web Animation using Animate CC",
            modules: [
              {
                name: "Web Animation using Animate CC",
                software: "Adobe Animate",
          ...
          },
          {
            ...
            hours: 40,
            certificate:
              "Certificate of Participation in Building Next Generation Websites",
            modules: [
              {
                name: "Building Next Generation Websites",
                software: "HTML5, CSS3 and Javascript",
...
export async function generateMetadata({ params }) {
  ...
  const seo = courseSeo[slug];
  const title = seo?.title || course.title;
  const description = seo?.description || course.description;
    ...
    <>
      <JsonLd
        ...
        data={courseJsonLd({
          ...
          path: `/courses/${slug}`,
          timeRequired: course.totalHours
            ? `PT${course.totalHours}H`
            : undefined,
        })}
      />
      <JsonLd
