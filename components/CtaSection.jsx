      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mb-8">
            Speak with our academic advisors for personalized guidance based on
            your goals, background, and career aspirations.
          </p>
            ...
            <Button
              ...
              text={
                <div className="flex gap-2">
                  <Headphones size={18} /> Talk to Advisor
                </div>
              }
            />
            {/* <Button
              ...
              text={
                <div className="flex gap-2">
                  <Calendar size={18} /> Schedule a Callback
                </div>
              }
            /> */}
          </div>
          ...
          {/* <p className="mt-6 text-gray-400 text-sm">
            ⚡ Free career counseling session valued at ₦25,000 — available for
            limited time
          </p> */}
        </div>
      </div>
