        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(ellipse, rgba(96,165,250,0.22) 0%, rgba(139,92,246,0.15) 60%, transparent 80%)",
              }}
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.05 }}
            >
              <p className=" text-gray-400 mb-0.5">Alumni worldwide</p>
              <p className="font-semibold text-blue-400">
                🚀 <Counter to={2000} />+ Graduates
              </p>
            </motion.div>

            {/* Top-right floating tag */}
            <motion.div
              className="absolute top-6 right-6 bg-[#020B2D]/80 backdrop-blur-lg border border-purple-500/30 px-3 py-2 rounded-xl  z-10"
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
